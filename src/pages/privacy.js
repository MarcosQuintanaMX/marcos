...
const privacy = () => {
  return (
    <Layout>
      <section className="section-center p-4 border rounded-2xl bg-slate-50">
        <h3>Aviso de privacidad integral</h3>
        <p className="">
          Marcos Ivan Quintana mejor conocido como Marcos, con domicilio en
          Eindhoven, Brabante Septentrional, Países Bajos; y portal de internet
          marcosquintana.com, es el responsable del uso y protección de sus
          datos personales, y al respecto le informamos lo siguiente: ¿Para qué
          fines utilizaremos sus datos personales? Los datos personales que
          recabamos de usted, los utilizaremos para las siguientes finalidades
          que son necesarias para el servicio que solicita: Respuesta a mensajes
          del formulario de contacto, Prestación de cualquier servicio
        ...
        <p>
          ...
          petición vía correo electrónico a yo@marcosquintana.com y deberá
          contener:
        </p>
        <p>
          <ul>
            <li>
              * Nombre completo del titular. * Domicilio. * Teléfono. * Correo
              electrónico usado en este sitio web. * Copia de una identificación
              oficial adjunta. * Asunto «Derechos ARCO»
            </li>
          </ul>
        </p>
        <p>
        ...
        <p>Última actualización de este aviso de privacidad: 10/09/2022</p>
      </section>
    </Layout>
  )
}
